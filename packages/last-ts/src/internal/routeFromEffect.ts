/**
 * Route.fromEffect / staticFromEffect — literal param bags → schema phantoms +
 * bake metadata. No manual render annotations at the call site.
 */
...
export type FromEffectValue = {
  ...
  /** When true, expand these rows for SSG bake. */
