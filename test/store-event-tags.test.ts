...
import { makeRunResourceFactEvent } from "../src/internal/runResourceEvent";
import { buildQueueEvent } from "../src/QueueResource";
...
const runFactDecode = Schema.decodeUnknownSync(makeRunResourceFactEvent());
