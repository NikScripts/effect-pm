...
- **v0.7.0-beta.0** — Effect-first process runtime (`Polling` + `ProcessSchedule` layers, supervisor, exports). See `CHANGELOG.md` and the [API Reference](https://hyperlink.cool/api/hyperlink-ts) / [Daemon guide](./docs/guides/daemons.md).
