...
| **Address-less IPC** | `pnpm run example:addressless-ipc-lookup` |
...
| [`forms/resource/addressless-ipc-lookup.ts`](./forms/resource/addressless-ipc-lookup.ts) | Address-less IPC `Node` + Lookup — two processes, `lookupClient` |
