/**
 * @module examples/hyperlink-web/server
 *
...
class WnbaStore extends Store.Service<WnbaStore>("@examples/hyperlink-web/WnbaStore")(
  WnbaNode.logs,
  WorkPool.store(BoxScoreQueue),
) {}

class LiveStore extends Store.Service<LiveStore>("@examples/hyperlink-web/LiveStore")(
  LiveNode.logs,
  Daemon.store(LiveScorePoller),
  Gate.store(FetchGate),
) {}

class StatsStore extends Store.Service<StatsStore>("@examples/hyperlink-web/StatsStore")(
  StatsNode.logs,
