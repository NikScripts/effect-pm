/**
 * @module examples/hyperlink-cli/counter-cli
 *
 ...
 *
 *   tsx examples/hyperlink-cli/counter-cli.ts counter current
 *   tsx examples/hyperlink-cli/counter-cli.ts counter increment --by 5
 *   tsx examples/hyperlink-cli/counter-cli.ts --help
 *
