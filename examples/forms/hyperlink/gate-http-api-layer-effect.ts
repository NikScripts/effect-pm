...
>()("hyperlink-ts/examples/forms/hyperlink/gate-http-api-layer-effect/DecodeCapture") {}
...
export class DemoApiClient extends Context.Service<DemoApiClient>()(
  "hyperlink-ts/examples/forms/hyperlink/gate-http-api-layer-effect/DemoApiClient",
  {
    make: _make,
  },
) {
