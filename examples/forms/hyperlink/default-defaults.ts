/**
 * @module examples/forms/hyperlink/default-defaults
 *
 ...
 *
 * ```bash
 * pnpm exec tsx examples/forms/hyperlink/default-defaults.ts
 * ```
 *
 * Docs: `docs/examples/hyperlink/default-defaults.md` includes this file;
