...
| **5c** | **ProcessStore split** — `Telemetry.Tag` + wiring stack, router + sinks, telemetry state; archive vs projection; unified Protocol | [20-process-store-split-and-telemetry.md](./20-process-store-split-and-telemetry.md) · vocabulary [21](./21-state-vocabulary.md) · **SSoT** [telemetry-requirements.md](../recipes/telemetry-requirements.md) |
