...
// prettier-ignore
import type { getConfig as File_ApiEffectPmModuleSymbol_getConfig } from './pages/api/hyperlink-ts/[module]/[symbol]';
// prettier-ignore
...
| ({ path: '/api/hyperlink-ts/[module]/[symbol]' } & GetConfigResponse<typeof File_ApiEffectPmModuleSymbol_getConfig>)
