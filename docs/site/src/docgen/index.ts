 ...
 *
 * Each capability is an Effect service behind a layer; wire the ones you need. Currently: the compiler
 * substrate ({@link TsProgram}), the location→url index ({@link SymbolIndex}), and compiler resolution
 * ({@link LinkResolver}). Extraction and rendering land in later phases.
 *
 * @since 1.0.0
 */
