...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [wire groups & identity](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) · [W3 incident](./agent-04-w3-incident-2026-07-27.md) | **Eng W1–W2 only**; W3 Family attempt **reverted off tip** (`5a0b42d5`) | `5a0b42d5` | W1–W2 prior green | **W3 design-only** — no Eng; **do not push `integration` without owner OK** | 2026-07-27 |
...
1. **Agent 4:** Wire identity **W1–W2 Eng** ([`wire-groups-and-identity.md`](../plans/wire-groups-and-identity.md)). W3 Family/`serveFamily` Eng **rejected** — tip force-reset to `5a0b42d5`; write-up [`agent-04-w3-incident-2026-07-27.md`](./agent-04-w3-incident-2026-07-27.md). Service shapes: `Tag`/`value`/`promise`/`pure` Eng’d; Creating polish + handle adornments **paused**. **W3 design-only** (Tag overload / API handle + reserved features nest under discussion). **Never push `integration` without explicit owner authorization.**
