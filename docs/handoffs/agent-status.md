...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Locked #27 Eng** — `Directory.changes` membership push | tip-syncing | typecheck + lookup-directory | Owner: C bake #28–37; peer hot-rebind follow-up | 2026-07-29 |
