...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **in progress** — listen-set bind + Node.forward/Active (β) | ahead of last tip-sync | forward-proxy + address-policy green | Update API parked; rewrite dream-redeploy onto forward; tip-sync when owner says Sync | 2026-08-11 |
