...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · [UI Route](./ui-routes-dream.md) | **dreaming** — Route+Router only; do not merge without ask | work branch ahead | ui-routes + ui-router | F5 flake pre-existing; land/delete GroupRoute owner-gated | 2026-07-29 |
