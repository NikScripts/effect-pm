...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [addresses + update API](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) · [Lifecycle](../guides/lifecycle.md) | **tip-synced** — update API lean: compose plan → execute; addresses still design | same tip as `integration` | design doc only (no Eng) | Plan composition surface + module home next; dream-redeploy provisional | 2026-08-07 |
