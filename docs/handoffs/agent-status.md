...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **tip-synced** — R1+R3+R3b live Redis on `integration` | same tip as `integration` | typecheck 0 / redis live 7 + gate fleet green | R2 `metrics` nest · R4 HttpApiClient+ApiMetrics | 2026-07-27 |
...
1. **Agent 4:** W1–W3 + `default`/`defaults` + **R1+R3+R3b live Redis tip-synced** ([`../plans/fleet-rate-limiting.md`](../plans/fleet-rate-limiting.md)). Next: R2 `metrics` nest → R4 HttpApiClient Tag + absorb ApiMetrics. Incident: [`agent-04-w3-incident-2026-07-27.md`](./agent-04-w3-incident-2026-07-27.md).
