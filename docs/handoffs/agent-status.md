...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **beta audit** — A+B Eng'd; hardening in flight | branch tip | CSPRNG token, HandleNotReady, logs, guide | Next: finish verify + Track C bake | 2026-07-27 |
...
3. **This agent (Launcher):** Track A+B Eng'd; **beta audit** (API/tests/docs/observability) before Track C. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md). Guide: [`docs/guides/launcher.md`](../guides/launcher.md).
