...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Locked #27 Eng** — `Directory.changes` membership push | 280fdc41 | typecheck 0; lookup-directory 15/15 | Owner: C bake #28–37; peer hot-rebind follow-up | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** Track A+B Eng'd; **Locked #27** membership push Eng'd (`Directory.changes` / `Lookup.directoryTable`). Remainder Track C bake #28–37 awaiting owner lock. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
