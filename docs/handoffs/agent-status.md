...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **plan** — dream kernel plan + lock register; substrate Eng’d; awaiting P1–P12 | off `integration` | lifecycle + work-pool tests | Owner: walk P1–P12; L0 land when said; no dream Eng until locks; versioned / #35–37 deferred | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle **kernel plan** + P-lock register ready — [`lifecycle-kernel.md`](../plans/lifecycle-kernel.md) / [`lifecycle-kernel-decisions.md`](./lifecycle-kernel-decisions.md). Substrate Eng’d on `cursor/lifecycle-defer-start-929b` (await L0). Owner walks P1–P12 before dream Eng (L1 = WorkPool `make` SSOT). Versioned schema still design-only; else `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
