...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **Eng** — `View.Prototype` + reversed Tag; `View.bind`; compose | `282dd104d` | ui-view + view-proto-infer | Notes: [`view-tag-prototype.md`](./view-tag-prototype.md). Size add-on `View.card`/`detail`/`page`. Next: peel chrome further; `View.only` WorkerPool. | 2026-07-27 | 2026-07-27 |
