...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/repo-dev-cli-125f` | repo `hyp` Effect CLI | **in flight** — scaffold + verify/check wired | branch tip | `pnpm hyp --help` | Next: fold remaining **dev** scripts; examples later; CI later | 2026-07-22 |
