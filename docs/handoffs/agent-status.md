...
| **G / TUI** | `cursor/file-router-prototype-125f` | [file-router](./file-router-prototype.md) · [Page naming](./view-page-naming.md) · [UI Route](./ui-routes-dream.md) | **Eng** — provides pipe, `Page.*`, fileRoot, vite plugin, `hyp file-router`; Page.Tag deferred | — | ui/web/tui tsc + file-router tests | Page.Tag + docs-site createPages cutover | 2026-07-31 |
