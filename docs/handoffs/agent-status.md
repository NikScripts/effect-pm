...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — #33 `Hyperlink.withHandoff` | same tip as `integration` | typecheck 0; handoff/shutdown green | Next: owner-lock #34–37; lookupClient rebind | 2026-07-29 |
