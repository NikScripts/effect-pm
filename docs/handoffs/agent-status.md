...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · `View` redesign · **F5 split-dial** | **Eng** — Dashboards on `DashboardViews.layer`; F5 Eng'd; tip-synced with `integration` | `16b72457e` | ui-node-status-bundle 3/3; demo `hyperlink-web` on :5177 + :7780–7782 | Next: peel DetailScreen; **hold** kit Dashboard. F5: [`loud-failures-design.md`](./loud-failures-design.md) §10. Hard-refresh http://localhost:5177/ | 2026-07-27 |
