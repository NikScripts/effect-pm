...
| **K** | `cursor/agent-k-page-route-6d0e` | [**spine**](./last-ts-spine.md) · [**last site Frame**](../../docs/last/site/) · [**Catalog fromEffect**](../../examples/last/from-effect/Catalog.ts) · [**API audit**](./agent-invented-api-audit.md) | **Eng** — Phase A Frame/NavBar/Sidebar/Main/Footer + `Layout.provide(Frame.App)` | ahead of `integration` | site typecheck / `docs:last-site` | B–E: main group · fileSystem · fromEffect · Provider | 2026-08-12 |
...
2. **Agent K:** spine + **Catalog `fromEffect`** ([`Catalog.ts`](../../examples/last/from-effect/Catalog.ts)) tip-synced. Park: [`owned-string-casing-park.md`](./owned-string-casing-park.md).
