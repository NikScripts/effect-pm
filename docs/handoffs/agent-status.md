...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [Lifecycle](../guides/lifecycle.md) | **Lifecycle closed** (G chrome); Versioned design on tip — not Eng'd | same tip as `integration` | Lifecycle suites green on tip | Owner go: Versioned Eng · explicit A/B · `restartSuccessor` · #36–37 · Track D redirect | 2026-08-02 |
