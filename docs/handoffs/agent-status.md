...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · detail peel · **Bundle.observe dogfood** | **pushed** — peel + atom-backed bundles | `69b5b6fad` | typecheck 0; atom+bundle+view-data 10/10 | Hold kit Dashboard; TanStack adapters parallel | 2026-07-29 |
...
2. **Agent G / TUI:** View compose + detail peel (shell back/title) + **`Hyperlink.atom/fn` in `*Bundle`** + web/TUI **`Bundle.observe` dogfood** on `cursor/view-withsize-types-125f` — guides [`../guides/view-tag-types.md`](../guides/view-tag-types.md) · [`../guides/hyperlink-atom.md`](../guides/hyperlink-atom.md) · [`../guides/bundles.md`](../guides/bundles.md). **Hold kit Dashboard** (owner).
