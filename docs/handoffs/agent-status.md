...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **pushed** — Eng’d LookupPolicy + NodePolicy (PolicyBuilder) | work branch ahead of `integration` (await owner tip-sync) | lookup/node/policy-builder suites green | Address + Node.make pipe | 2026-08-10 |
