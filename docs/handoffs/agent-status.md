...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Dashboard unhold | **tip-synced** — NodeStatusHost + public node chrome (K2 0–2 overlay) | same tip as `integration` | typecheck 0 | **owner fork:** overlay vs Navigator page; F5 flake | 2026-07-29 |
...
2. **Agent G / TUI:** Dashboard unheld; TopBar/DetailChrome + `NodeStatusHost` Eng’d (overlays). **Blocked on owner:** node status as Navigator page skin vs keep overlays. Branch `cursor/view-withsize-types-125f`.
