...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **restartSuccessor example** — live OS A→B recipe + blocked planUpdate demo | same tip as `integration` | example:launcher-restart-successor + suites | Dual-serve / redirect / live clientsAtRisk still deferred | 2026-08-07 |
