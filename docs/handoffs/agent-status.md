...
| **G / TUI** | `cursor/file-router-prototype-125f` | [last-ts codesplit](../plans/last-ts-codesplit.md) · [file-router](./file-router-prototype.md) | **Eng** — P0–P1: `packages/last-ts` (Page, AtomReact, vite); hyperlink re-exports | work tip | ui tsc + ui-file-router | Next: P2 Route/Router; P3 View→last-ts + `Ui` | 2026-08-02 |
