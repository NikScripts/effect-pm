...
| **TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity | **in flight** on tip (was overlapping Agent 4 row) | tip | `vitest test/resource-cli` | Remaining TUI kinds: gate/api/fleetHealth/telemetry/shardMap | 2026-07-24 |
