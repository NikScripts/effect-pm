...
| **G / TUI** | `cursor/file-router-prototype-125f` | [file-router](./file-router-prototype.md) · [guide](../guides/file-router.md) · [Page naming](./view-page-naming.md) | **Eng** — file-router guide + codegen demo; tip had Dashboard/`Page.*`/beta.102 | work tip | example:ui-file-router-codegen | Next: Page.Tag + docs-site createPages; tip-sync again when ready | 2026-08-02 |
