...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [legacy docs](./legacy-docs-migration.md) · [examples book](./agent-01-examples-book.md) | **Eng** — E2b done; forms/hyperlink fully paired (32 include pages) | work branch | check-twoslash-includes 32/32 | IA lock owner-open; E3 schedule/polling next | 2026-07-29 |
