...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/beta0-release-prep-125f` | beta.0 release prep (changelog · kill `clientHttp` · `HYPERLINK_CLIENT_HOST`) | **ready** — Eng green | `5349b69ad` | typecheck / lint / test / markers green | Owner still: publish, `effect-hyperlink` keep/unpublish, docs domain. `hyp` CLI parked on [#78](https://github.com/nikolasstow/Hyperlink/pull/78) | 2026-07-24 |
