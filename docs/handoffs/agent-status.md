...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [wire groups & identity](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) · [W3 incident](./agent-04-w3-incident-2026-07-27.md) | **W1–W3 + `default`/`defaults` Eng’d** — `pure` retired; ApiMetrics migrate **paused** | `5753b3df` | typecheck + resource-default tests | **do not push `integration` without owner OK**; wait on metrics / `cell` | 2026-07-27 |
