...
| **5** | `cursor/policy-dial-cutover-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Eng** — Policy + sticky / continuous streams | on branch | typecheck green; policy + rebind + d3 peers | `restartSuccessor` / #35–37 deferred | 2026-07-30 |
