...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — C Locked #27–33; `Node.drain` Eng'd | same tip as `integration` | typecheck 0; node-drain + lookup-directory | Next: `Node.shutdown` (#32) → handoff layer (#33) | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** Track C Locked #27–33; Eng'd membership push + `Node.drain`/`phase`. Next Eng: `Node.shutdown` then per-service handoff layer. Deferred bake #34–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
