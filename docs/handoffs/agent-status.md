...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **done (this cut)** — Memory/History.fromApi; deleted Router.memory/history/unsafeService + public Page.Document; guide scrub | — | vitest subsets | tip-sync to integration | 2026-08-15 |
