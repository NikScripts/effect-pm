...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/repo-dev-cli-125f` | repo `hl` Effect CLI | **in flight** — scaffold + verify/check wired | branch tip | `pnpm hl --help` | Next: fold docs/example scripts; CI later | 2026-07-22 |
