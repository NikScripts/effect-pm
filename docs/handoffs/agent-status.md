...
| **2** | `cursor/process-run-rpc-a009` | [process run RPC](./agent-02-process-run-rpc.md) | **ready-for-merge** | `cb53c1d` | typecheck + 456 tests + lint green | PR [#26](https://github.com/NikScripts/effect-pm/pull/26); merged `b693cc9` | 2026-07-12 |
