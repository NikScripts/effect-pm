...
| **2** | `cursor/queue-wire-phase-1a-a009` | [queue wire Phase 1a](./agent-02-queue-wire-phase-1a.md) | **ready-for-merge** [#21](https://github.com/NikScripts/effect-pm/pull/21) | `5dbf812` | typecheck + test + lint green | changeset on owner OK; #17 rebase after merge | 2026-07-11 |
