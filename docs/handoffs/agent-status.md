...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — view-typed-jsx SSOT + scrubbed sidebar/bookchrome/`ViewDemo` off `static layer` | same tip as `integration` | Twoslash + view-default + example smoke | T2e dogfood still open | 2026-08-15 |
