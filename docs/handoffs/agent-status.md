...
| **5** | `cursor/lookup-advice-watch-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **landed** — Track D Advice.changes early move on `integration` | same tip as `integration` | advice 4/4; rebind 3/3 | D remainder / `restartSuccessor` / #35–37 deferred | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** #39 + Ink + Track D v1 retry on tip; **Advice.changes early move Eng’d** (`lookupClient` adopts on prefer flip). Next: D remainder / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
