...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced / idle** — Track C #27–33 Eng'd | same tip as `integration` | typecheck 0; handoff green | Awaiting owner-lock #34–37; Track D lookupClient | 2026-07-29 |
