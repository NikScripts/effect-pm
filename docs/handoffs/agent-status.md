...
| **2** | `integration/storage` | [queue wire Phase 1a](./agent-02-queue-wire-phase-1a.md) + Session 3 consumer docs | **merged** [#21](https://github.com/NikScripts/effect-pm/pull/21) + [#17](https://github.com/NikScripts/effect-pm/pull/17) | `c3d5054` | typecheck + 450 tests + lint green | RPC error wire deferred (owner); changeset on owner OK | 2026-07-11 |
