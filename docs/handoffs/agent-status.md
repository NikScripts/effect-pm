...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **docs** — full class examples on `/docs/view-tag-types` | `4158e58f5` | `http://100.67.32.32:5190/docs/view-tag-types` → 200 | Visible `class PoolCard` / Prototype / Layer — not cut-away type aliases. | 2026-07-28 |
