...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Eng'ing** — lookupClient hot-rebind | ahead of `integration` | in progress | Land then tip-sync | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** Track C #27–33 Eng'd; Eng'ing Track D `lookupClient` Directory hot-rebind. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
