...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **Eng** — construction adornments A1–A2 (`defaults` Svc remap) | work branch tip | typecheck pending | A1–A2 Eng’d; optional A3 sugar; `cell` park lean | 2026-07-27 |
