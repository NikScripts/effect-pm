...
| **5** | `cursor/lifecycle-defer-start-929b` | [addresses dock](./node-addresses-and-update-api.md) §3.3.3 | **FIRED (play)** — Play B struck; D1–D31 locks remain; serve API open | ahead of last tip-sync | — | Owner fired play. Do not invent serve API | 2026-08-16 |
