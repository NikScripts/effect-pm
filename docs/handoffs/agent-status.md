...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · `View` redesign | **Eng** — WorkPool widgets on existing Dashboard via View | tip-sync after push | ui-view + workpool-view + typecheck | Next: migrate other widget families; **hold** kit Dashboard. Notes: [`client-adapters-design.md`](./client-adapters-design.md). | 2026-07-27 |
