...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [anyUnknown plan](../plans/any-unknown-in-error-context.md) — HS open `R` + docs | **anyUnknown cleared** — batches 0–5 Eng’d; tip-synced; back to docs | same tip as `integration` | typecheck 0 (both tsconfigs) | Prior beta0/`Hyperlink.cli` on tip; next: docs | 2026-07-24 |
