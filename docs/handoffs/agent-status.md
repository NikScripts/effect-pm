...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **1** | `cursor/docs-corpus-phase1-plan-ce05` | [docs corpus](./agent-01-docs-corpus.md) · [**Phase 1 plan**](./agent-01-docs-corpus-phase1-plan.md) | **plan locked — await batch unlock** | tip of plan branch | inventory + posture | Archive-first; defer edge cases/deletes to owner; no mass moves yet | 2026-07-14 |
...
1. **Agent 1:** Phase 1 posture **locked** (thorough / archive-first / defer to owner) — [`agent-01-docs-corpus-phase1-plan.md`](./agent-01-docs-corpus-phase1-plan.md). **Unlock a batch (A–Z)** before any `git mv`. No UI / `docs/site` chrome.
