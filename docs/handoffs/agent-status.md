...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **tip-synced** — dream redeploy API docs (file-swap + restartSuccessor recipe) | same tip as `integration` | example + live suite green | Explicit Redirect SDK deferred; stream resume optional | 2026-08-07 |
