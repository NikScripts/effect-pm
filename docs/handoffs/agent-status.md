...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**spine**](./last-ts-spine.md) · [**last site**](../../docs/last/site/) · [**Catalog fromEffect**](../../examples/last/from-effect/Catalog.ts) | **design lock** — track 1: context + `Last.link`; track 2 router-provide parked | ahead of `integration` | lock doc | Eng track 1 next; no track 2 until 1 ships | 2026-08-13 |
