...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — product 1 + Track A API | branch tip | docs only | Custody handle + `up` locked. Open: assume wire, timeouts, handle type name | 2026-07-27 |
