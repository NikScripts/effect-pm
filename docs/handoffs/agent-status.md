...
| **K** | `cursor/agent-k-page-route-6d0e` | [**corrections**](./last-ts-api-corrections.md) · [Document](./page-document-lock.md) · [Layout](./page-layout-lock.md) · [Page mint](./page-mint-lock.md) · [HttpApi](./router-httpapi-lock.md) | **ahead** — host prop adapt + Document + Layout + Page mint + Last site | tip | last-ts tsc + host/page tests + docs/last/site tsc | Hyperlink `docs/site` still grandfathered | 2026-08-10 |
