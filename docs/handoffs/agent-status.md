...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Nameless Lookup Soft-bake (all listens) | **Eng’d** — tip-synced | same tip as `integration` | typecheck + listen suites green | http/ws/nPipe Soft-bake match unix | 2026-07-25 |
...
1. **Agent 4:** Listen family + nameless Lookup Soft-bake Eng’d. Next chapter (Creating a Hyperlink) on owner call.
