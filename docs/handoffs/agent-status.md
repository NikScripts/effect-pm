...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — view-typed-jsx SSOT + static-layer scrub (side quest reverted) | same tip as `integration` | Twoslash + view-default smoke | continue site demo from here | 2026-08-15 |
