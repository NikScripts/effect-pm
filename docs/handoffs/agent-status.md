...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **on branch** — view-typed-jsx demo `ui/`+`lib/` SSOT (no `static layer` teaching); Link tip still ahead of `integration` | `6bde38b50` | Twoslash check + example smoke | tip-sync when owner says Sync | 2026-08-15 |
