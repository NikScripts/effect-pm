...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **Eng** — `views` + WorkerPool `View.only` e2e | *(push tip)* | typecheck / ui-view | Notes: [`view-tag-prototype.md`](./view-tag-prototype.md). Next: `ui.data` on compose; Page logs/schedule. | 2026-07-28 |
