...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **Eng** — construction adornments A1–A2 (`defaults` Service widen) | work branch tip | typecheck 0 / hyperlink-default 12/12 | A1–A2 Eng’d; optional A3 sugar; `cell` park lean; tip-sync when authorized | 2026-07-27 |
...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — Track A API locked (#1–21) | branch tip | docs only | Awaiting owner **Eng go**. Open: Tracks B/C/D | 2026-07-27 |
