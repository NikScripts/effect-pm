...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **restartSuccessor Eng'd** — plan → up B → shutdown A; ambient AlreadyUp / Plan Layers | tip-sync pending | lookup-plan-update + restart-successor + launcher suites | Dual-serve / redirect / live clientsAtRisk still deferred | 2026-08-07 |
