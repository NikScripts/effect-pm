...
| **Docs site** | from `integration` (local) | [origin down / CF 504](./docs-site-origin-down.md) | **outage** — DO origin not answering | — | live 504s | Local agent: `doctl` + redeploy; cloud agent has no DO access | 2026-07-27 |
