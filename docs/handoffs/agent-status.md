...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Observe recipes plan | **ready** — packs on `*View.pack` | tip on push | typecheck 0 | Next: Eng Phase 0; kit HOLD | 2026-07-29 |
