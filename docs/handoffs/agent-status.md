...
| **K** | `cursor/agent-k-page-route-6d0e` | [**spine**](./last-ts-spine.md) · [**API audit**](./agent-invented-api-audit.md) · [corrections](./last-ts-api-corrections.md) | **ahead** — invented-API inventory filed; waiting owner delete list | tip | audit only (no Eng) | docs/site still on createPages; fileRoot/fromEffect/Document.set still live | 2026-08-11 |
