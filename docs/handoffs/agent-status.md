...
| **G / TUI** | `cursor/view-withsize-types-125f` | TUI ↔ web Dashboard Group parity · **View compose** · Requirement / SizeChrome | **eng** — `ViewKind` TaggedEnum (PascalCase `_tag` + `Match.tag`); Requirement / SizeChrome | branch tip | typecheck + view suites | Notes: [`client-adapters-design.md`](./client-adapters-design.md); hold kit Dashboard | 2026-07-28 |
