...
| **G / TUI** | `cursor/file-router-prototype-125f` | [last-ts codesplit](../plans/last-ts-codesplit.md) · [file-router](./file-router-prototype.md) | **Eng** — P0–P3: last-ts has Page, AtomReact, vite, Route/Router, View, docgen; hyperlink `Ui` + Target | work tip | last-ts tsc + ui router/view suites | Next: Page.Tag + createPages; P4 shims / `Ui.Card` rename | 2026-08-02 |
