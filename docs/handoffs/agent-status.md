...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · [UI Route](./ui-routes-dream.md) · [site routes](./waku-site-routes-api.md) | **Router core** — Group helpers → `GroupNav`; site soft-nav | tip ahead of `integration` until sync | ui-router tests | ask before sync | 2026-07-30 |
...
2. **Agent G / TUI:** Router dream — core Router nav only; Group drill-down in `ui/GroupNav`; site soft-nav ([`ui-routes-dream.md`](./ui-routes-dream.md)). Ask before syncing `integration`.
