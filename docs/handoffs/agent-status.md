...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **tip-synced** — A/C reshape + L0–L5 on `integration` | same tip as `integration` | typecheck green; lifecycle/contract/http 30/30; example OK | Next: L6 docs / P8 remote `from`; more Effect-native polish | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle A/C + L0–L5 **tip-synced**. Next: L6 docs clarity / P8 remote `from` / further Effect-native polish / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
