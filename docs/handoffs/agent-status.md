...
| **G / TUI** | `cursor/view-withsize-types-125f` | TUI ↔ web Dashboard Group parity · **View compose** · `ui.data` | **eng** — compose `data` door + shared `ui/runtime` RuntimeProvider | branch tip | typecheck 0; view suites + data 18/18 | Hold kit Dashboard | 2026-07-28 |
