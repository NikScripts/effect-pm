...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **Eng’d ahead of tip** — L0–L5 (`ServiceCore`/`ServicePausable`, `lifecycleEvents`, `ui/LifecycleView`) | ahead of `integration` | typecheck green; lifecycle/contract/http 29/29; example OK | tip-sync on owner ask; P5 chrome→G; P7 no Lifecycle gate (Locked) | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle L0–L5 Eng’d on work branch (caps, `lifecycleEvents`, `ui/LifecycleView`) — **awaiting tip-sync**. Next: P7/P8→L6 / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
