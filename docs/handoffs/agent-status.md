...
| **2** | `cursor/process-run-rpc-a009` | [process run RPC](./agent-02-process-run-rpc.md) | **ready-for-merge** | pending push | typecheck + 455 tests green | No changeset (owner OK); Slice 0: **`run`**, void payload | 2026-07-12 |
