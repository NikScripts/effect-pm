...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **docs** — real `hyperlink-ts/ui` twoslash | `4590a1975` | `http://100.67.32.32:5190/docs/view-tag-types` → 200 | Real `View.Card.Tag` / `PoolCard["Service"]` popups. Prefer `Tag["Service"]`. | 2026-07-28 |
