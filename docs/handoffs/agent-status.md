...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **Eng'd** — Track A+B on tip | branch tip | onYield + membership example | Next: Track C bake | 2026-07-27 |
...
3. **This agent (Launcher):** Track A+B Eng'd (`Launcher` custody + Lookup membership / `onYield`). Next bake Track C. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
