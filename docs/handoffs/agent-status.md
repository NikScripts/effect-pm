...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Launcher refinements** — kill/Tags/Config-at-spawn/`layer`/`entry` | same tip as `integration` | typecheck + launcher suites | Owner: lock C #27–36 | 2026-07-28 |
