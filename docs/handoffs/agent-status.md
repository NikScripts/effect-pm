...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **proposal** — fleet rate limit research; W1–W3 + `default`/`defaults` on `integration` | `f30c3eb3` | proposal doc | owner locks on store / Soft / nest name before R1 Eng | 2026-07-27 |
