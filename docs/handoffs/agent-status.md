...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **Eng’d ahead of tip** — L0–L5 (`ServiceCore`/`ServicePausable`, `lifecycleEvents`, `ui/LifecycleView`) | ahead of `integration` | typecheck green; lifecycle/contract/http 29/29; example OK | tip-sync on owner ask; P5 chrome / P7 handoff gate open | 2026-07-31 |
