...
| **K** | `cursor/agent-k-page-route-6d0e` | [**Agent K handoff**](./agent-k-page-route-handoff.md) · [page/route lock](./page-route-make-lock.md) · [rsc-router](../last/rsc-router.md) | **ahead of `integration`** — live `:5220` smoke + `pages.gen` align Eng’d | a57e3cb29 | vitest page/route + pages-gen-align; curl `/` `/guides/routing` `/docs/intro/rest` 200 | owner: PR land + `version` | 2026-08-08 |
...
2. **Agent K:** last-ts + file-router on `cursor/agent-k-page-route-6d0e` (from `file-router-prototype-125f`). Live smoke + `pageConfig` `pages.gen` align Eng’d. Handoff: [`agent-k-page-route-handoff.md`](./agent-k-page-route-handoff.md). Park: [`owned-string-casing-park.md`](./owned-string-casing-park.md).
