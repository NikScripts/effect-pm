...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-syncing** — C Locked #27–33; `Node.drain` Eng | same tip as `integration` | typecheck 0; node-drain + lookup-directory | Next: `Node.shutdown` (#32) → handoff layer (#33) | 2026-07-29 |
