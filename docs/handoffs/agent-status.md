...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — product 1 + Track A API | branch tip | docs only | ReadyTimedOut/ChildExited/assume-* locked. Open: token format, package export | 2026-07-27 |
