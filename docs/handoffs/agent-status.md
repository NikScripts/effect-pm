...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**spine**](./last-ts-spine.md) · [**last site**](../../docs/last/site/) · [**Catalog fromEffect**](../../examples/last/from-effect/Catalog.ts) · park: [**repo source viewer**](./repo-source-viewer-park.md) | **Eng** — track 1 `Last.context`/`use`/`link` + Link `out`; track 2 parked | ahead of `integration` | `test/last-context-link.test.tsx` | track 2 parked · `/repo/*` viewer idea parked | 2026-08-13 |
...
2. **Agent K:** spine + **Catalog `fromEffect`** ([`Catalog.ts`](../../examples/last/from-effect/Catalog.ts)) tip-synced. Parks: [`owned-string-casing-park.md`](./owned-string-casing-park.md) · [`repo-source-viewer-park.md`](./repo-source-viewer-park.md) (`/repo/…` Twoslash — after context).
