...
1. **Agent 1:** Date-stamped stack (`2026-*.md`) — **14 deleted** as complete; **4 deferred** for owner. Next stack blocked until those four are called. No UI / `docs/site` chrome.
