...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **plan** — Effect-shaped dream (`run`+Latch+FiberHandle/Set); substrate Eng’d; awaiting P-locks | off `integration` | lifecycle + work-pool tests | Owner: walk P1–P13 (esp. P13); L0 when said; no dream Eng until locks | 2026-07-31 |
