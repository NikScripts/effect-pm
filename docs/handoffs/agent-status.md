...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Dashboard unhold | **Eng** — NodeStatusHost + public node chrome (K2 0–2 overlay) | same tip as `integration` | typecheck TBD | owner fork: overlay vs Navigator page; F5 flake | 2026-07-29 |
