...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **Eng’d ahead of tip** — A/C reshape (dual ops, fibers/Latch, derived events) + L0–L5 | ahead of `integration` | typecheck green; lifecycle/contract/http 30/30; example OK | tip-sync on owner ask; P5 chrome→G; P7 orthogonal | 2026-07-31 |
