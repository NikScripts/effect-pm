...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — product 1 + Track A API | branch tip | docs only | Token = Effect Random + Redacted locked. Open: package export; Eng go? | 2026-07-27 |
