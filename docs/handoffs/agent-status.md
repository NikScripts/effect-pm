...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · `View.provide` · **atom + Bundle.observe** | **pushed** — observe slice | tip (atom/Bundle) | typecheck 0; atom+bundle 7/7 | Hold kit Dashboard; TanStack adapters parallel | 2026-07-28 |
...
2. **Agent G / TUI:** View compose + **`View.provide`** + **`Hyperlink.atom/query/fn`** + **`Bundle.observe`** on `cursor/view-withsize-types-125f` — guides [`../guides/view-tag-types.md`](../guides/view-tag-types.md) · [`../guides/hyperlink-atom.md`](../guides/hyperlink-atom.md) · [`../guides/bundles.md`](../guides/bundles.md). Hold kit Dashboard.
