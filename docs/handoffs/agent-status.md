...
| **G / TUI** | `cursor/file-router-prototype-125f` | [last-ts codesplit](../plans/last-ts-codesplit.md) · [file-router](./file-router-prototype.md) | **Eng** — last-ts View kernel only; sizes/bind/Service tags on `Ui`; Route/Router/Page/docgen moved | work tip | last-ts tsc + ui-view suites | Next: Page.Tag + createPages; P4 shims | 2026-08-02 |
