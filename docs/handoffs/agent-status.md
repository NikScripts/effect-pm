...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **Eng’d ahead of tip** — B Participating duals + P11 internal split (A/C + L0–L5 tip-synced) | ahead of `integration` | typecheck green; lifecycle+contract 29/29; example OK | Next: tip-sync on ask; P8 remote duals; Agent G chrome | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle A/C + L0–L5 tip-synced; **B + P11 Eng’d** on work branch (lean Participating duals; `internal/lifecycle` + `lifecycleModel`). L6 handoff prose in guide. Next: tip-sync on ask / P8 remote duals / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
