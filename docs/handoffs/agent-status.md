...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · **DashboardLayer + Shell** · Bundle.observe | **pushed** — shell extract | `ed8dc15a7` | typecheck 0; atom+bundle+view-data 10/10 | Hold kit Dashboard; TanStack parallel | 2026-07-29 |
