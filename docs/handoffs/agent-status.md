...
| **G / TUI** | `cursor/view-withsize-types-125f` | TUI ↔ web Dashboard Group parity · **View compose** · Tag mint | **eng** — one-shot `View.Card.Tag<Self, Props>()(key, statics)`; `PropsOf` / `["Service"]` | branch tip | typecheck + view suites | Next: `ui.data` on compose; hold kit Dashboard | 2026-07-28 |
