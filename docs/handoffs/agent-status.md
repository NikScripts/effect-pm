...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [legacy docs](./legacy-docs-migration.md) · [examples book](./agent-01-examples-book.md) | **Eng** — E0–E4 examples book done; **blocked on E5 apps** (owner) | work branch | check-twoslash-includes | Owner: E5 app pairing shape; IA lock still open | 2026-07-29 |
