...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) · [**context/link**](./last-context-view-lock.md) | **tip-synced** — outdated API cleanup + Memory/History.fromApi on tip | same tip as `integration` | vitest subsets green | next: links (`Last.link` / `Router.link`) | 2026-08-15 |
