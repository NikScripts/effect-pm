...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — T2e + T2f Eng’d (`last-context` guide) | same tip as `integration` | context-link + hub + guide | — | 2026-08-15 |
