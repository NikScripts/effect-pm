...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **tip-synced** — L0–L6 (Tag overloads + P8 remote + P11) | same tip as `integration` | typecheck green; lifecycle local+remote OK | Next: owner P10/P12 (L7); Agent G chrome; `restartSuccessor` / #35–37 deferred | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle **L0–L6 tip-synced** (Tag overloads; P8 remote duals; P11 split). Next: owner on **P10/P12** before L7; Agent G chrome; `restartSuccessor` / #35–37 deferred. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
