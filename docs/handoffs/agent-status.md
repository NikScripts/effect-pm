...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **Eng** — `View.View` rename + views polish | *(push tip)* | ui-view + view-proto-infer | Notes: [`view-tag-prototype.md`](./view-tag-prototype.md). Next: `ui.data`; Page logs/schedule. | 2026-07-28 |
