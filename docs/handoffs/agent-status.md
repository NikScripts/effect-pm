...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **in flight** — `Link.To` / `Out` / `View` Eng’d | — | vitest link/router green | tip-sync after review | 2026-08-15 |
