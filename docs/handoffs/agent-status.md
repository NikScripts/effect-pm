...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **POC** — Effect-faithful View Tag (`DenseCard["Service"]`) | `86ee56c87` | view-effect-service-poc.test-d | Notes: [`view-tag-prototype.md`](./view-tag-prototype.md). Ask before baking into shipped View. | 2026-07-28 |
