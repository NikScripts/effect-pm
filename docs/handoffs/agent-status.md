...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Observe Phases 0–4 | **tip-synced** — Observe packs; Bundle/`use*Bundle`/`data` removed | `aa02fc237` | typecheck 0 | kit HOLD; optional compositional non-queue packs | 2026-07-29 |
