...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Getting started docs — [Core Concepts](../getting-started/core-concepts.md) (after Install) | **docs** — refining Core Concepts | tip | — | Owner review Core Concepts; then Managing Layers | 2026-07-24 |
