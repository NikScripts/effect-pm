...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) · [**last site**](./last-ts-site-framework.md) | **tip-synced** — last-ts site View kits live (`ui/` leaf HTML + host root) | same tip as `integration` | playwright :5220 | live http://100.67.32.32:5220/ · Twoslash `/docs/last-rsc-router` | 2026-08-16 |
