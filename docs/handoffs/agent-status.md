...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — shutdown/launch + peersLayer rebind | same tip as `integration` | typecheck 0; shutdown/peers green | Next: handoff layer (#33); land | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** Track C Locked #27–33; Eng'd `Directory.changes`, `Node.drain`/`shutdown`/`launch`, directory `peersLayer` rebind. Next: #33 handoff layer. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
