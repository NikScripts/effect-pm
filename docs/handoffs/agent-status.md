...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **Eng #34** — workPoolRelease peer enqueue | tip-sync after land | typecheck TBD | #34 Eng in flight; #35–37 deferred | 2026-07-29 |
