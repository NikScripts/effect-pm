...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — Locked #27 Eng'd; contains `integration` tip | 9cf2cc1b | typecheck 0; lookup-directory 15/15 | Land #27 to `integration` needs owner push go; C bake #28–37; peer hot-rebind | 2026-07-29 |
...
3. **Agent 5 (Launcher + handoff):** tip-synced (contains `integration`; ahead with A/B refinements + Locked #27). Remainder Track C bake #28–37 awaiting owner lock. Land to `integration` needs explicit push go. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
