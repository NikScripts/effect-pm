...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [anyUnknown plan](../plans/any-unknown-in-error-context.md) — HS open `R` + critique follow-through | **tip-synced** — `serveRemoteDriver` on `integration` | same tip as `integration` (`f0630818`) | typecheck 0 (both tsconfigs) | Remaining erase: toLayer / wire provideContext / D1 servers; next: docs | 2026-07-24 |
