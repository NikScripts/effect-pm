...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **R2 Eng’d** (work branch) — metrics nest + R1+R3+R3b on tip | work tip | typecheck + gate metrics tests | tip-sync · R4 HttpApiClient+ApiMetrics | 2026-07-27 |
