...
| **G / TUI** | `cursor/file-router-prototype-125f` | [file-router](./file-router-prototype.md) · [Page naming](./view-page-naming.md) · [UI Route](./ui-routes-dream.md) | **Eng** — Dashboard thin shells (`internal/web\|tuiDashboard`); one `ui/DashboardViews`; Effect beta.102; `Page.*` / file-router | work tip | typecheck + ui-dashboard-views | Page.Tag + docs-site createPages cutover | 2026-08-01 |
