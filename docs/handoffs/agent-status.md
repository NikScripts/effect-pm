...
| **G / TUI** | `cursor/view-withsize-types-125f` | TUI ↔ web Dashboard Group parity · **View compose** · Bundles | **in progress** — Bundles guide + thin-handle standard | ahead of `integration` (docs) | typecheck n/a (docs) | Prefer `Bundle.observe`; Hold kit Dashboard | 2026-07-28 |
...
2. **Agent G / TUI:** View compose + Tag mint on `cursor/view-withsize-types-125f` — lock [`view-compose-lock.md`](./view-compose-lock.md); Bundles guide [`../guides/bundles.md`](../guides/bundles.md); principle [`../standards/principles.md#handles-stay-thin`](../standards/principles.md#handles-stay-thin) (`Bundle.observe`, not `ui.data.*` / Tag methods). Hold kit Dashboard.
