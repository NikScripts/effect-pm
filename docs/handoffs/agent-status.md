...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · detail peel · **Bundle.observe dogfood** | **pushed** — peel + atom-backed bundles | tip (this push) | typecheck 0; atom+bundle tests | Hold kit Dashboard; TanStack adapters parallel | 2026-07-29 |
