...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **vocab purge** — HyperService surface; Track C bake proposed | tip-synced | typecheck + key suites | Owner: lock C #27–36; optional `docs/resources/` folder rename | 2026-07-28 |
...
3. **This agent (Launcher):** Track A+B Eng'd; **HyperService vocab purge** on tip (`ServiceReadiness`, status/health `services`, verify `serviceKey`); Track C bake #27–36 proposed. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md). Rename SSOT: [`rename-hyperlink-handoff.md`](./rename-hyperlink-handoff.md).
