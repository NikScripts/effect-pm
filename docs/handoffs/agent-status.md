...
| **5** | `cursor/lifecycle-defer-start-929b` | [addresses dock](./node-addresses-and-update-api.md) §3.3.3 | **owner fired play** — rev9 states `group`/`layer`/`Handlers` API | ahead of last tip-sync | — | Stopped per owner | 2026-08-16 |
