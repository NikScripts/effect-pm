...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **tip-synced** — Update pass-3 (findTargetEntry, contracts, lookupFirst) | same tip as `integration` | `test/update.test.ts` (31) + shutdown + restart | Node.make / Host|Machine / proxy still design | 2026-08-08 |
