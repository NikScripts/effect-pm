...
| **3** | `cursor/logs-store-followers-plan-906e` | [identity-coordinator](./identity-coordinator.md) · [loud-failures](./loud-failures-design.md) | **M4 Eng’d** — identity liveness + coordinator example | same tip as `integration` | identity + lookup tests | M5 placement advice later; Soft/memo parked | 2026-07-21 |
