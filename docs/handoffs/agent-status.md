...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [service shapes plan](../plans/service-shapes.md) | **Eng’d** — tip-synced | `5c1992cb` (= `integration`) | typecheck + tag-iface/value-plain suites | Next: `Hyperlink.promise`, then `pure` | 2026-07-26 |
