...
| **G / TUI** | `cursor/file-router-prototype-125f` | [file-router prototype](./file-router-prototype.md) · [UI Route](./ui-routes-dream.md) · [owned-string park](./owned-string-casing-park.md) | **prototype** — typed `FilePath` union via codegen; dream `Route.fileRoot` sketched | — | `tsc -p src/ui` + file-router test-d | not on package exports; createPages cutover owner-gated | 2026-07-31 |
