...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — docs Twoslash + island (view-typed-jsx); last-site View kits dogfood separate | same tip as `integration` | playwright island | http://100.67.32.32:5190/docs/view-typed-jsx | 2026-08-16 |
