...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — product 1 + Track A API | branch tip | docs only | Library launcher (α); spawn→awaitReady→handoff/`Node.assume`; **no Eng until API locked**. Open: spawn input + custody vs flat | 2026-07-27 |
