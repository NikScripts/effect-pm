...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **tip-synced** — dual `Policy.layer` + runtime config (not phantom) | same tip as `integration` | typecheck + policy suites + cutover example | Explicit Redirect SDK deferred; stream resume optional | 2026-08-07 |
