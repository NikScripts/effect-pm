...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **cleanup+tests done** — ready for Track C bake | same tip as `integration` | typecheck + launcher suites | Owner: lock C #27–36 | 2026-07-28 |
...
3. **Agent 5 (Launcher + handoff):** Track A+B Eng'd; refinements + **cleanup/docs/thorough tests** on tip — ready for Track C bake #27–36. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md). Rename SSOT: [`rename-hyperlink-handoff.md`](./rename-hyperlink-handoff.md).
