...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) | **bake** — product 1 + Track A API | branch tip | docs only | `Launcher.Handle` + `up` locked. Open: assume wire, ready-timeout errors | 2026-07-27 |
