...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [legacy docs](./legacy-docs-migration.md) · [examples book](./agent-01-examples-book.md) | **Blocked** — E0–E4 done; L5 tip-fixes landed; need owner on **E5 apps** + **IA (L6)** | work branch | include 50/50; smoke examples | Owner: E5 pairing shape; sidebar IA lock | 2026-07-29 |
