...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [wire groups & identity](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) · [W3 incident](./agent-04-w3-incident-2026-07-27.md) | **W1–W3 + `default`/`defaults` Eng’d** — finishing + sync to `integration` | *(tip on push)* | typecheck + resource-default tests | next unlock: ApiMetrics / Gate nest / `cell` | 2026-07-27 |
