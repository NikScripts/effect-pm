...
| **G / TUI** | `cursor/file-router-prototype-125f` | [**router HttpApi lock**](./router-httpapi-lock.md) · [effect app router](./effect-app-router-plan.md) | **Design locked** — Router = HttpApi; Page = success kind (params/query/… identical); tip still URL-surface mix-in | work tip | lock doc; prior mix-in tests green | **Eng rewrite:** Page success + Handlers dispatch; retire URL-only projection | 2026-08-06 |
