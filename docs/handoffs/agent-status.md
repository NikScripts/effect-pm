...
| **G / TUI** | `cursor/file-router-prototype-125f` | [**page/route make lock**](./page-route-make-lock.md) · [last-ts site](./last-ts-site-framework.md) · [rsc-router](../last/rsc-router.md) | **Eng** fileRootFromPages catalog + static chapter + `[...path]` — tip=`integration` | *(push tip)* | page/route/from-page tests; `:5220` 200 | owner: PR + `version` | 2026-08-08 |
