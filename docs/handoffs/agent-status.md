...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity | **syncing** — `hyperlink-ts/ui` SSOT + Group TUI; merging `integration` | (push tip) | merge + tests | Prior Agent-4 open-`R` work tip-synced idle on integration; kind parity still web-ahead | 2026-07-24 |
