...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · **Bundle.observe = one door** | **pushed** — soft-deprecate ui.data | `b0a426176` | typecheck 0 | Hold kit Dashboard; TanStack parallel | 2026-07-29 |
