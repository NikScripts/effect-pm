...
| **5** | `cursor/track-d-client-retry-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **landing** — Track D v1 lookupClient retry + #39/Ink already on tip | → `integration` | lookup-client-rebind 2/2 | D remainder / `restartSuccessor` / #35–37 deferred | 2026-07-29 |
