...
| **G / TUI** | `cursor/view-withsize-types-125f` | TUI ↔ web Dashboard Group parity · **View compose** · `View.provide` | **in progress** — typed skin provide | ahead of `integration` | typecheck + view suites | Prefer `View.provide` / `Tag.provide`; Hold kit Dashboard | 2026-07-28 |
...
2. **Agent G / TUI:** View compose + Tag mint + **`View.provide`** on `cursor/view-withsize-types-125f` — guide [`../guides/view-tag-types.md`](../guides/view-tag-types.md); Bundles [`../guides/bundles.md`](../guides/bundles.md); thin handles [`../standards/principles.md#handles-stay-thin`](../standards/principles.md#handles-stay-thin). Hold kit Dashboard.
