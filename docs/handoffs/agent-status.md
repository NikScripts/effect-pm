...
| **5** | `cursor/policy-dial-cutover-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **pushed** — Policy Eng + guide/example (`docs/guides/policy.md`, `example:node-policy-lookup-cutover`) | tip | typecheck; 89 policy/lookup/handoff tests | F5 ui-node-status flake pre-existing; `restartSuccessor` / #35–37 deferred | 2026-07-30 |
...
3. **Agent 5 (Launcher + handoff):** #39 + Ink + Track D on tip; **Policy Eng** + docs/example (`docs/guides/policy.md`, nav Guides, `example:node-policy-lookup-cutover`). Next: `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
