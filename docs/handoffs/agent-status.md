...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **in progress** — dream β + forwardAll WorkPool one-shots | ahead of last tip-sync | dream-redeploy example + live test green | Update parked; stream/ref forward + verify; unixFromKey; S14; tip-sync when Sync | 2026-08-11 |
