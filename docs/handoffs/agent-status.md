...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **Eng’d ahead of tip** — P8 remote dual acceptance (`lifecycle-remote-http`); B+P11 tip-synced | ahead of `integration` | remote Lifecycle duals 4/4 | Next: owner `@locked` P8; tip-sync on ask; Agent G chrome; `restartSuccessor` / #35–37 | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** B+P11 tip-synced; **P8 remote dual acceptance Eng’d** (`test/lifecycle-remote-http.test.ts`) — await owner `@locked` to close L6. Next: tip-sync on ask / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
