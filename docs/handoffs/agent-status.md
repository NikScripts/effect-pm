...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — last-ts site View kits (`ui/` + Twoslash SSOT) | same tip as `integration` | last-site tsc | — | 2026-08-15 |
