...
2. ~~Agent 2 Phase 1a~~ — merged [#21](https://github.com/NikScripts/effect-pm/pull/21) into `integration/storage`
3. **PR #17** (Session 3 consumer docs) — rebase onto `integration/storage`; merge after verify
