...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **in progress** — public/private Node.make pipe (HttpApi) | ahead of last tip-sync | forward-proxy + address-policy + node-make | Update API parked; rewrite dream-redeploy onto forward; tip-sync when owner says Sync | 2026-08-11 |
