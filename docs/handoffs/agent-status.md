...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — #39 + strengthened A→B suite + docs | same tip as `integration` | handoff 13/13; ab-cutover 23/23 | `restartSuccessor` / serve `{ node }` / #35–37 deferred | 2026-07-29 |
