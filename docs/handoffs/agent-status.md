...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update + addresses](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) · [Lifecycle](../guides/lifecycle.md) | **tip-synced** — locality naming + `Node.make` (HttpApi-like) design | same tip as `integration` | design doc only (no Eng) | Lock Host/Machine/Locale + Node.make vs Tag; dream-redeploy provisional | 2026-08-08 |
