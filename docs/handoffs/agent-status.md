...
| **K** | `cursor/agent-k-page-route-6d0e` | [**Agent K handoff**](./agent-k-page-route-handoff.md) · [page/route lock](./page-route-make-lock.md) · [rsc-router](../last/rsc-router.md) | **ahead of `integration`** — live `:5220` smoke + `pages.gen` align Eng’d | (push tip) | vitest page/route + pages-gen-align; curl `/` `/guides/routing` `/docs/intro/rest` 200 | owner: PR land + `version` | 2026-08-08 |
