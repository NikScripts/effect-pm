...
| **G / TUI** | `cursor/file-router-prototype-125f` | [**page/route make lock**](./page-route-make-lock.md) · [last-ts site](./last-ts-site-framework.md) · [rsc-router](../last/rsc-router.md) | **Eng** Page.make + docs/last/site + fromPage + mixedFromEffect + ~ParamBags urls — tip=`integration` | work tip | page/route/from-effect tests; `:5220` 200 | RSC-safe catalog wiring; owner: PR + `version` | 2026-08-08 |
