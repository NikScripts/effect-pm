...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **Dialers + sticky dual-serve** — `clientsAtRisk` live census; `restartSuccessor` prefer(B) | tip-syncing | lookup-plan-update + restartSuccessor suites | Explicit Redirect SDK deferred; stream resume optional | 2026-08-07 |
