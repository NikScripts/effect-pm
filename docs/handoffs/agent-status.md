...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [service shapes plan](../plans/service-shapes.md) | **design** — tip-synced | same tip as `integration` | plan | Creating/Managing Layers paused; taxonomy draft for owner | 2026-07-25 |
