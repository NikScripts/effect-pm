...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/beta0-release-prep-125f` | beta.0 polish (npm metadata + live docs Process→Daemon) | **ready** — Eng green; on `integration` tip | same tip as `integration` | docs pass | Owner still: publish, `effect-hyperlink` keep/unpublish, docs domain | 2026-07-24 |
