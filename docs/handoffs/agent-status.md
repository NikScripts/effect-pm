...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Lifecycle](../guides/lifecycle.md) (L0–L7 done) | **Lifecycle closed** (except G chrome) — resume launcher / owner-gated follow-ups | same tip as `integration` | Lifecycle suites green on tip | Resume: explicit A/B launcher · `#35–37` · `restartSuccessor` · versioned schema — all owner-gated | 2026-08-02 |
