...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/repo-dev-cli-125f` | repo `hyp` Effect CLI | **in flight** — docs/clean/watch folded + CI workflow | branch tip | `pnpm hyp --help` / GHA `verify` | Next: verify membership (build/treeshake/manifest); examples later | 2026-07-22 |
