...
| **5** | `cursor/lifecycle-defer-start-929b` | [Lifecycle guide](../guides/lifecycle.md) · [kernel plan](../plans/lifecycle-kernel.md) · [P-locks](./lifecycle-kernel-decisions.md) · [launcher brief](./launcher-and-handoff-brief.md) | **tip-synced** — B Participating duals + P11 internal split (+ A/C + L0–L5) | same tip as `integration` | typecheck green; lifecycle+contract 29/29; example OK | Next: P8 remote duals; Agent G chrome; `restartSuccessor` / #35–37 | 2026-07-31 |
...
3. **Agent 5 (Launcher + handoff):** Lifecycle B + P11 **tip-synced** (Participating duals; `internal/lifecycle` + `lifecycleModel`; L6 handoff prose in guide). Next: P8 remote duals / `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
