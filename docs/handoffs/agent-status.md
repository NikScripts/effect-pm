...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **cloud** | `cursor/hyperservice-open-deps-5679` | [anyUnknown plan](../plans/any-unknown-in-error-context.md) — HS open `R` | **batches 0–2 done** — serve/listen/`*Server` preserve Dep | branch tip | type tests green; ~95 TS377030 remain (WP/store/daemon/tests) | Batches 3–5 still open | 2026-07-24 |
