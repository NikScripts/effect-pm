...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Versioned](./versioned-schema-decisions.md) · [deprecated](../guides/deprecated.md) · [Lifecycle](../guides/lifecycle.md) | **restartSuccessor live e2e** — plan → OS up B → shutdown A (askIncumbent dial-replace) | tip-sync pending | restart-successor live + plan-update + launcher suites | Dual-serve / redirect / live clientsAtRisk still deferred | 2026-08-07 |
