...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **Eng** — matchers on kit/`useMatch`; `View.Card`=size Prototype | `282dd104d` | ui-view + view-proto-infer | Notes: [`view-tag-prototype.md`](./view-tag-prototype.md). Next: `View.only` WorkerPool; `ui.data`. | 2026-07-27 | 2026-07-27 |
