...
| **5** | `cursor/lifecycle-defer-start-929b` | [addresses dock](./node-addresses-and-update-api.md) §3.3.3 | **design locked** — D1–D31 cut; Builder shape **open** (rename struck) | ahead of last tip-sync | owner: Ds good; make+add/extends like HttpApi | Design Builder before Eng/play. Sync when Sync | 2026-08-16 |
