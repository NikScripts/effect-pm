...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Observe recipes plan | **blocked** — pack NS name (`Live` rejected) | tip on branch | typecheck 0 | Name pack NS before Eng Phase 0; kit HOLD | 2026-07-29 |
...
2. **Agent G / TUI:** Observe recipes design-locked except **pack NS name** (`Live` rejected as worse than `Bundle`). Working label still `Bundle.*` in the plan. Owner picks noun → Eng Phase 0. Kit HOLD. Branch `cursor/view-withsize-types-125f`.
