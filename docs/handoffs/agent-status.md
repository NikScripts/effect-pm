...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **docs** — served View Tag types (Tailscale) | `76a0af2d5` | `http://100.67.32.32:5190/docs/view-tag-types` → 200 | Guide: [`../guides/view-tag-types.md`](../guides/view-tag-types.md). Prefer `Tag["Service"]`. Ask before baking POC mint into shipped View. | 2026-07-28 |
