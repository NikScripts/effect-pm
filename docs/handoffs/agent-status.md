...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Listen overload family alignment | **Eng’d** — tip-synced | same tip as `integration` | typecheck + listen suites green | Tag+impl nameless / +Node / single serve aligned | 2026-07-25 |
