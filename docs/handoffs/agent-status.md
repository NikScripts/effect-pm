...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · `View` redesign | **Eng** — kill groupId/short kinds; View reshape | same tip as `integration` | in flight | Notes: [`client-adapters-design.md`](./client-adapters-design.md) (W1–W15). Launcher: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md) | 2026-07-26 |
