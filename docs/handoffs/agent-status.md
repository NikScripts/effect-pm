...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **pushed** — PolicyBuilder: PascalCase tags → camelCase methods (`Uncapitalize`) | `6f2b7f4b` (1 ahead of `integration`; await owner tip-sync) | policy + policy-builder suites green | Node.make / Host|Machine / Eng NodePolicy + Policy→LookupPolicy | 2026-08-10 |
