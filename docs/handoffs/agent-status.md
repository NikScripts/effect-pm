...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Managing Layers polish | **Eng’d** — tip-synced | same tip as `integration` | docs | `​```listen` protocol toggle (all overloads × http/ws/unix/nPipe) | 2026-07-25 |
