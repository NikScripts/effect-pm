...
| **5** | `cursor/policy-dial-cutover-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **pushed** — Policy fold + polish/tests (PR pending) | tip | typecheck; 89 policy/lookup/handoff tests | F5 ui-node-status flake pre-existing; `restartSuccessor` / #35–37 deferred | 2026-07-30 |
