...
| **K** | `cursor/agent-k-page-route-6d0e` | [**corrections**](./last-ts-api-corrections.md) · [Document](./page-document-lock.md) · [Layout](./page-layout-lock.md) · [Page mint](./page-mint-lock.md) · [HttpApi](./router-httpapi-lock.md) | **ahead** — host + Document + Layout + Page mint Eng’d | tip | last-ts tsc + page/layout/router tests | fileRouter↔Page path wiring polish; Last site cutover | 2026-08-10 |
