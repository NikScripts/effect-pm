...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · `View` redesign | **Eng** — W20 `View.group` + `kit.for(tag)` + requireView/pinnedViewsOf | tip-synced with `integration` | ui-view tests + typecheck | Next: packaging / WorkPool migrate / Dashboard on kit. Notes: [`client-adapters-design.md`](./client-adapters-design.md) (W1–W20). | 2026-07-27 |
