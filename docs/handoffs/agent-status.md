...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [legacy docs](./legacy-docs-migration.md) · [examples book](./agent-01-examples-book.md) | **Eng** — E3 schedule/polling/store/dynamic-config paired | work branch | check-twoslash-includes | IA lock owner-open; E4 scenarios next | 2026-07-29 |
