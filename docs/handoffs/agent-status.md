...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | [fleet rate limiting](../plans/fleet-rate-limiting.md) · [wire groups](../plans/wire-groups-and-identity.md) · [service shapes](../plans/service-shapes.md) | **R2 Eng’d** (work branch) — metrics nest + R1+R3+R3b on tip | `b0977852` | typecheck 0 / gate 30 | tip-sync · R4 HttpApiClient+ApiMetrics | 2026-07-27 |
...
1. **Agent 4:** W1–W3 + `default`/`defaults` + **R1+R3+R3b** tip-synced; **R2 metrics nest Eng’d** on work branch ([`../plans/fleet-rate-limiting.md`](../plans/fleet-rate-limiting.md)). Next after tip-sync: R4 HttpApiClient Tag + absorb ApiMetrics. Incident: [`agent-04-w3-incident-2026-07-27.md`](./agent-04-w3-incident-2026-07-27.md).
