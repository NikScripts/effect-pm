...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Managing Layers polish | **Eng’d** — tip-syncing | tip | docs | Listen family + Soft-bake reflected in getting-started | 2026-07-25 |
