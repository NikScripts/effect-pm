...
| **K** | `cursor/agent-k-page-route-6d0e` | [**spine**](./last-ts-spine.md) · [demo](../../examples/last/spine/) · [Twoslash](../examples/last/last-ts-spine.md) · [corrections](./last-ts-api-corrections.md) | **ahead** — deleted app `waku.server` / `_root` (Waku createPages not product) | tip | spine tsc + Twoslash | internal host bridge still open; no app createPages | 2026-08-11 |
