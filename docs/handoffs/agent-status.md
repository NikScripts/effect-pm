...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Observe Phases 0–3 | **pushed** — all `*View.pack` + web/TUI dogfood; Bundle shim | `b2c6df636` | typecheck 0 · observe/pack tests 8/8 | Phase 4 delete Bundle/`use*Bundle`; kit HOLD | 2026-07-29 |
