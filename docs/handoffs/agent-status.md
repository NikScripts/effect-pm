...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**spine**](./last-ts-spine.md) · [**last site**](../../docs/last/site/) · [**Catalog fromEffect**](../../examples/last/from-effect/Catalog.ts) · park: [**repo source viewer**](./repo-source-viewer-park.md) | **tip-synced** — track 1 context/link done; track 2 router-scoped context **next** | same tip as `integration` | demo + `test/last-context-link.test.tsx` + twoslash green | track 2 Eng next · `/repo/*` still parked | 2026-08-13 |
...
2. **Agent K:** track 1 `Last.context` / `Last.link` **tip-synced**. **Next:** track 2 router/builder-scoped context ([`last-context-view-lock.md`](./last-context-view-lock.md)). Parks: [`owned-string-casing-park.md`](./owned-string-casing-park.md) · [`repo-source-viewer-park.md`](./repo-source-viewer-park.md).
