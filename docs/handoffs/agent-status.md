...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/repo-dev-cli-125f` | repo `hyp` Effect CLI | **in flight** — verify=build+markers; Cursor must-rules; GHA blocked on billing | branch tip | local gates green; GHA not started (account billing lock) | **Need owner:** unlock GitHub Actions billing. Next: examples later; Agent C audit still owner-gated | 2026-07-22 |
