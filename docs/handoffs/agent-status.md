...
| **3** | `cursor/store-read-rqb-where-906e` | [Logs store followers](./agent-03-logs-p1.md) · [plan](./agent-03-logs-store-followers-plan.md) | **building `store-read-0`** | — | — | Unified Store read payload + full Drizzle-RQB nested `where`; followers next | 2026-07-14 |
...
1. **Agent 3:** [`agent-03-logs-store-followers-plan.md`](./agent-03-logs-store-followers-plan.md) posted — owner unlocks `followers-0`…`followers-3`.
...
### Ready / owner calls
4. Unlock store-follower slice: `followers-0` (factory) / `0–2` / `0–3` (full)
