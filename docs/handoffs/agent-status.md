...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — `Link.To` / `Out` / `View` on tip | same tip as `integration` | vitest link/router green | — | 2026-08-15 |
