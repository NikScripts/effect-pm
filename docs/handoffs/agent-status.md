...
| **5** | `cursor/lifecycle-defer-start-929b` | [addresses dock](./node-addresses-and-update-api.md) §3.3.3 | **play B** — `Node.handle` / `layer` (one module); Builder shape open | ahead of last tip-sync | owner: review play B | Design serve API before Eng. Sync when Sync | 2026-08-16 |
