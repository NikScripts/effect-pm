...
| **5** | `cursor/policy-dial-cutover-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **pushed** — Policy + sticky / continuous streams (PR pending approval) | `727f752f` | typecheck green; policy + rebind + d3 peers | land to `integration` when PR approved; `restartSuccessor` / #35–37 deferred | 2026-07-30 |
...
3. **Agent 5 (Launcher + handoff):** #39 + Ink + Track D on tip; **Policy Eng** (`hyperlink-ts/Policy` sticky / streamGap / cold). Next: `restartSuccessor` / #35–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
