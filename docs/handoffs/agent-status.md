...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/repo-dev-cli-125f` | repo `hyp` Effect CLI · [#78](https://github.com/nikolasstow/Hyperlink/pull/78) | **ready** — Eng complete; CI deferred | `07d9a1eb9` | typecheck / lint / test / markers green locally | GHA verify workflow present but skipped. Merge when owner wants. Follow-ups: manifest generator, examples under hyp later | 2026-07-22 |
