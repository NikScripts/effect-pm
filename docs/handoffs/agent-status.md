...
| **5** | `cursor/versioned-schema-design-929b` | [versioned schema](./versioned-schema-decisions.md) · [launcher + handoff brief](./launcher-and-handoff-brief.md) | **design** — Versioned decisions bake (not Eng'd) | off `integration` | — | owner go before Eng; `restartSuccessor` / #36–37 deferred | 2026-07-30 |
...
3. **Agent 5 (Launcher + handoff):** Policy + Track C/D + docs tip-synced. **Versioned schema decisions** on `cursor/versioned-schema-design-929b` ([`versioned-schema-decisions.md`](./versioned-schema-decisions.md)) — owner go before Eng. Next otherwise: `restartSuccessor` / #36–37. Brief: [`launcher-and-handoff-brief.md`](./launcher-and-handoff-brief.md).
