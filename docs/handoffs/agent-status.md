...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **tip-synced** — Update 2nd pass (array blockers, shape gate, spans, Advice leave) | same tip as `integration` | `test/update.test.ts` (27) + shutdown Advice + dream-redeploy | Node.make / Host|Machine / proxy still design | 2026-08-08 |
