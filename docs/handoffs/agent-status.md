...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · **View compose** · F5 | **Eng** — `View.Tag` class handles; `View.resource` (was `View.tag`); compose+Navigator | `3da306f50` | ui-view + ui-navigator | Lock: [`view-compose-lock.md`](./view-compose-lock.md). **hold** kit Dashboard. Next: `View.only` WorkerPool; `ui.data`; page content skins. | 2026-07-27 |
