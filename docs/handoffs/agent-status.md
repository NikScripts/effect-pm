...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-synced** — #39 PascalCase reasons + `_tag` match + A→B suite | same tip as `integration` | handoff+cutover 37/37; test-d lock | `restartSuccessor` / serve `{ node }` / #35–37 deferred | 2026-07-29 |
