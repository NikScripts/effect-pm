...
| **K** | `cursor/agent-k-page-route-6d0e` | [**corrections**](./last-ts-api-corrections.md) · [Document lock](./page-document-lock.md) · [HttpApi](./router-httpapi-lock.md) | **ahead** — host façades + Document design lock (not Eng’d) | 09834d9a3 | dogfood build OK | Eng Document needs go | 2026-08-10 |
