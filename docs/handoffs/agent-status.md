...
| **Launcher** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **URLs + vocab** — `docs/services/`; `/docs/hyperlinks` (+ redirect) | tip-synced | typecheck + docs:manifest | Owner: lock C #27–36 | 2026-07-28 |
