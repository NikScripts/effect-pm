...
| **K** | `cursor/agent-k-page-route-6d0e` | [**context/view lock**](./last-context-view-lock.md) · [**API audit**](./agent-invented-api-audit.md) · [**spine**](./last-ts-spine.md) | **tip-synced** — fix View↔Last kindSym TDZ crash on view-typed-jsx island | same tip as `integration` | vitest cycle + page on :5190 | live http://100.67.32.32:5190/docs/view-typed-jsx | 2026-08-16 |
