...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Dashboard unhold | **tip-synced** — Dashboard unheld; TopBar/DetailChrome public (K2 0–1) | same tip as `integration` | typecheck 0 | K2 slice 2 node status next; F5 flake pre-existing | 2026-07-29 |
