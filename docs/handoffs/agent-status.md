...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Managing Layers polish | **Eng’d** — tip-synced | same tip as `integration` | docs | Dropped v3 `*Live` layer names (`inProcess` / camelCase) | 2026-07-25 |
