...
| **2** | `cursor/process-run-rpc-a009` | [process run RPC](./agent-02-process-run-rpc.md) | **ready-for-merge** | `9fd82d6` | typecheck + 455 tests green | PR [#26](https://github.com/NikScripts/effect-pm/pull/26); no changeset (owner OK) | 2026-07-12 |
