...
| **G / TUI** | `cursor/file-router-prototype-125f` | [**router HttpApi lock**](./router-httpapi-lock.md) · [last-ts site](./last-ts-site-framework.md) · [effect app router](./effect-app-router-plan.md) | **Eng** View.Service default slots + site dogfood start; Router Page handlers on tip | work tip | view-service-default + router-builder green; last-ts tsc green | site phases 2–4 (book chrome → Router catalog → Page marks); then hyperlink migrate | 2026-08-07 |
