...
| **5** | `cursor/launcher-handoff-design-929b` | [launcher + handoff brief](./launcher-and-handoff-brief.md) · [rename](./rename-hyperlink-handoff.md) | **tip-syncing** — `shutdown`/`launch` + peersLayer rebind | pending | typecheck + shutdown/peers suites | Next: handoff layer (#33); land | 2026-07-29 |
