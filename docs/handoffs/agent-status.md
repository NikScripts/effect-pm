...
| **G / TUI** | `cursor/tui-dashboard-parity-125f` | TUI ↔ web Dashboard Group parity · `View` redesign | **Eng** — W21 + WorkPoolView packaging (ui/web/tui subpaths) | tip-sync after push | ui-view + workpool-view + typecheck | Next: Dashboard kit wire; retire forKind. Notes: [`client-adapters-design.md`](./client-adapters-design.md). | 2026-07-27 |
