...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · **Bundle.observe = one door** | **pushed** — soft-deprecate ui.data | `c7a76422e` | typecheck 0 | Hold kit Dashboard; TanStack parallel | 2026-07-29 |
