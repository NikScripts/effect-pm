...
| **G / TUI** | `cursor/view-withsize-types-125f` | View compose · Shell · Observe Phase 0 | **pushed** — Observe + WorkPoolView.pack | tip on push | typecheck 0 | Phase 1 dogfood; kit HOLD | 2026-07-29 |
...
2. **Agent G / TUI:** Observe Phase 0 Eng’d — `hyperlink-ts/Observe` + `WorkPoolView.pack`. Next: dogfood skins / port packs / retire `Bundle.observe`. Kit HOLD. Branch `cursor/view-withsize-types-125f`.
