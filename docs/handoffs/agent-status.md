...
| **Docs site** | `cursor/docs-site-edge-cache-dbdc` (ε) | [origin down](./docs-site-origin-down.md) · edge cache · SEO/landing | **tip-synced** — SEO/landing live on prod; processSlot Shiki singleton next | same tip as `integration` | `/healthz` ok; landing CTAs; favicon/og/canonical; CF MISS→HIT; origin robots.txt | 1Password CLI backup deferred; CF AI-signals can mask public `/robots.txt` | 2026-07-27 |
