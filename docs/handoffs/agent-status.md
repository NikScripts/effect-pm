...
| **E** | `cursor/verify-connection-deep-906e` | [impossible-states](./impossible-states-proposal.md) · [loud-failures](./loud-failures-design.md) · [verify-connection](./verify-connection-classification.md) | **loud-failures F2/F3 Eng’d** | PR tip | deep verify + ProtocolMismatch + MissingClientProtocol | [#77](https://github.com/NikScripts/effect-pm/pull/77). contractHash / default-on verify still later | 2026-07-21 |
