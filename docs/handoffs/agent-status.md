...
| **G / TUI** | `cursor/file-router-prototype-125f` | [last-ts codesplit](../plans/last-ts-codesplit.md) · [file-router](./file-router-prototype.md) · [guide](../guides/file-router.md) | **Plan** — last-ts / Ui / View split locked in plan; `last-ts@0.0.0` reserved | work tip | — | Next: lock `Last` v1 members; P0 workspace skeleton | 2026-08-02 |
