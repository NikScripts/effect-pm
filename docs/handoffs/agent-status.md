...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **tip-synced** — LookupPolicy + NodePolicy Eng’d | same tip as `integration` (`8c9f9f37`) | lookup/node/policy-builder suites green | Address + Node.make pipe | 2026-08-10 |
