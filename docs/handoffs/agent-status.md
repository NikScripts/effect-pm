...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **4** | `cursor/hyperservice-open-deps-5679` | Creating a Hyperlink | **Eng’d** — tip-synced | same tip as `integration` | docs | Lowercase glossary + Counter walkthrough polish; Managing Layers done | 2026-07-25 |
