...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **in progress** — primary/listen/advertise resolve + label-constrained as | ahead of last tip-sync | address-policy / node-make suites | multi-row Directory advertise; unixFromKey Config; tip-sync when owner says Sync | 2026-08-11 |
