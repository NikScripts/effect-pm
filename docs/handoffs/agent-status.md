...
|-------|--------|---------|-------|---------|--------------|-----------------|---------------|
| **1** | `cursor/docs-corpus-beta22-walk-ce05` | [docs corpus](./agent-01-docs-corpus.md) · [open asks](./open-asks.md) | **date stack closed — withReadiness pipe type hygiene** | tip of beta22-walk | tsgo + tsc typecheck | Next Phase-1 stack; open-asks §1–3 parked | 2026-07-14 |
