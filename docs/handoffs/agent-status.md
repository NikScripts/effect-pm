...
| **5** | `cursor/lifecycle-defer-start-929b` | [launcher brief](./launcher-and-handoff-brief.md) · [Update](../guides/update.md) · [addresses dock](./node-addresses-and-update-api.md) · [Versioned](./versioned-schema-decisions.md) | **in progress** — dream-redeploy Shape β (forward+activate) | ahead of last tip-sync | dream-redeploy example + live test; forward-proxy | Update parked; WorkPool+forwardAll gap; unixFromKey bind; tip-sync when owner says Sync | 2026-08-11 |
