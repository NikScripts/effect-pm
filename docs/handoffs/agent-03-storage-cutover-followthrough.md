...
Finish **consumer cutover + remaining Soft parity** after #62. Living docs/examples teach bake+override; CustomQueue has Soft SQLite / sibling-merge proofs matching Process/Queue/Run.
...
| **S3** | CustomQueue Soft SQLite `provideMerge` + sibling-merge empty-file guards |
