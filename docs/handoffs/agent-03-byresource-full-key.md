...
**Status:** **PLAN-FIRST** — supervisor assign 2026-07-14.  
**Agent:** **3**  
**Branch from:** **`integration`** tip (after [#57](https://github.com/NikScripts/effect-pm/pull/57) merges preferred — private `_logs` is on that PR).  
...
**Prior tracks (done — do not reopen):** Process.events [#47](https://github.com/NikScripts/effect-pm/pull/47)/[#51](https://github.com/NikScripts/effect-pm/pull/51) · lineage append [#48](https://github.com/NikScripts/effect-pm/pull/48) · ready-perfection [#52](https://github.com/NikScripts/effect-pm/pull/52) · store memo deferred · `_logs` private journal ([#57](https://github.com/NikScripts/effect-pm/pull/57), Manager).
