...
**Legend:** 🔶 forms TBD (walk) · 🕓 deferred · ⛔ dropped / not-a-thing

Item IDs are stable — reference them when we lock forms (e.g. "S3", "C2").

---

## 1. Module functions — `State`
| id | symbol | role | forms |
|---|---|---|---|
