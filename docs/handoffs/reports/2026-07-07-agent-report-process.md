...
**Session 3 (2026-07-10, `cursor/process-consumer-docs-a009`):** Agent 2 recommends **defer**. Consumer docs updated (`PROCESS-API.md`, `guides/process.md`) — ready for merge pending owner confirmation. **No `processSpec` rebuild** unless owner explicitly funds it. No code or RPC spec changes in this session.
