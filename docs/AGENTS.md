...
Use this file **together with** [STORAGE.md](./STORAGE.md) (**read before any persistence change**), [plans/21-state-vocabulary.md](./plans/21-state-vocabulary.md), **[handoffs/telemetry-step52-transition-handoff.md](./handoffs/telemetry-step52-transition-handoff.md)** (**telemetry implementation — start here**), [recipes/telemetry-requirements.md](./recipes/telemetry-requirements.md) (**telemetry API SSoT**), [handoffs/telemetry-implementation-handoff.md](./handoffs/telemetry-implementation-handoff.md) (canonical API summary), [recipes/telemetry-split-bake.md](./recipes/telemetry-split-bake.md) (**historical**), [PACKAGE-GUIDE.md](./PACKAGE-GUIDE.md), [PROCESS-API.md](./PROCESS-API.md), [RESOURCE-API.md](./RESOURCE-API.md), [SCHEDULE-AND-PROCESSGROUP.md](./SCHEDULE-AND-PROCESSGROUP.md), and [examples/README.md](../examples/README.md).
