 ...
 * @module ui/View
 *
 * View namespace for apps — DI kernel from `last-ts/View` plus Hyperlink size chrome,
 * Registry, bind/only, react, and compose. Same `View.Card.Tag` / `View.bind` API as before.
 */
...
import {
  Prototype,
  type FulfilledPrototype,
  type OpenPrototype,
  type View as ViewComponent,
  type ViewKey,
} from "last-ts/View";
...
/**
 * Component Svc for a View tag — defaults to {@link ViewProps} (same as pre-split).
 *
 * @public
 */
export type View<Props extends object = ViewProps> = ViewComponent<Props>;
