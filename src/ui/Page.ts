 ...
 * camelCase helpers. Not dashboard size chrome (`View.Page` / `ViewKind.Page`).
 *
 * ```ts
 ...
 *
 * @see docs/handoffs/view-page-naming.md
 * @see docs/handoffs/file-router-prototype.md
 */
...
export const StampTypeId = "~hyperlink-ts/ui/Page/stamp" as const;
